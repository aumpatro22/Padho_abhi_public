...
SECRET_KEY = os.environ['SECRET_KEY'] if os.environ.get('DEBUG', 'True').lower() not in ('true', '1', 'yes') else os.environ.get('SECRET_KEY', "django-insecure-m7_eo2cncht*+ke%yb&vow(%ik&rb_b#e%kwpcbd-^s_2&m#c=")
